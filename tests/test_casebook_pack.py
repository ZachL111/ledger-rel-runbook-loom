"""Regression checks for the ledger-rel-runbook-loom casebook."""
...
from casebook.harness import assert_expected, ledger_rel_runbook_loom_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(ledger_rel_runbook_loom_summary(), assert_expected())
